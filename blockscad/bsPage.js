...
output += '              <li><a href="#" id="examples_cube_with_cutouts">Scatola Parametrica</a></li>\n';
...
output += '              <li><a href="#" id="muro_mattoni">Muratura in mattoni</a></li>\n';
...
output += '              <li><a href="#" id="examples_sine_function_with_loop">Funzione sinusoidale</a></li>\n';
output += '            </ul>\n';
output += '          </li>\n';
output += '        </ul>\n';
